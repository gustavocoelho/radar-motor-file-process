...
public class A02_XXXXXXLayout {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		A02_XXXXXXLayout other = (A02_XXXXXXLayout) obj;
		if (header == null) {
	...
	public String toString() {
		return "A02_XXXXXXLayout [headerField=" + header + ", trailerField=" + trailer + "]";
	}
